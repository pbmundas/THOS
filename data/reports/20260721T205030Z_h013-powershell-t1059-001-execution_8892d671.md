...
> initiated 2026-07-21 20:50 UTC.
>
> **Bottom line:** [⚠ circumstantial] Deterministic detection layers flagged 24 record(s); analyst validation is required because the reasoning model did not return a response. (evidence: Sigma/detection matcher selected 24 of 38 processed…
>
...
### 📝 Security Findings
- [⚠ circumstantial] Deterministic detection layers flagged 24 record(s); analyst validation is required because the reasoning model did not return a response. (evidence: Sigma/detection matcher selected 24 of 38 processed records.; ref: 5)
...
curl -X POST http://localhost:8200/feedback \
  ...
  -d '{"hunt_id": "8892d671-27b9-499e-8ebb-24324911883e", "rating": "up/down/corrected", "correction": "Provide notes if rating is corrected"}'
```
