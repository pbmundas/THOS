...
AGENT_SPECS: tuple[AgentSpec, ...] = (
    ...
    AgentSpec(
        ...
        execution="single local LLM call with deterministic fallback",
    ...
    AgentSpec(
        ...
        execution="deterministic evidence correlation",
        resource_profile="CPU-light report parsing and bounded database reads; no model call",
